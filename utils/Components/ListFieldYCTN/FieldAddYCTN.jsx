...
const FieldAddYCTN = ({ loai_yctn, isAdd = true, toast, isEdit = false }) => {
  ...
  const handleInputChange = (fieldName, value) => {
    setFormData((prev) => {
      ...
      if (
        fieldName === "gtdt_truoc_thue" ||
        fieldName === "phan_tram_chiet_giam"
      ) {
        if (newData.gtdt_truoc_thue && newData.phan_tram_chiet_giam) {
          newData.gtdt_chiet_giam =
            (newData.phan_tram_chiet_giam * newData.gtdt_truoc_thue) / 100;
        }
      }
          ...
          <div style={{ width: "38%" }}>
            ...
            <div className="p-inputgroup">
              <InputNumber
                ...
                onChange={(e) => handleInputChange("gtdt_chiet_giam", e.value)}
                className="w-full"
                min={0}
              />
              <span
  ...
  return (
    <div className="">
      ...
      <div
        ...
        className="flex justify-content-end gap-2 mt-10 pt-5"
      >
        <Button
          label="Quay lại"
        ...
        {loai_yctn && (
          <Button
            label={"Tạo mới " + loai_yctn?.ten_loai_yc}
            icon="pi pi-check"
